...
function Contact() {
  return (
    <>
      <section
        id="contact"
        className="m-4 rounded-xl bg-blue-100 p-4 text-center text-lg shadow-[inset_0px_0px_3px_1px_#1a202c]"
      >
        <h1 className="pb-4 font-roboto text-4xl font-bold">Karol Has</h1>
